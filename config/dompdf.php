...
return [
    ...
    */
    ...
    'options' => [
        ...
        /**
         * Custom Unicode fonts: Abhaya Libre (Sinhala) and Noto Sans Tamil.
         */
        'font_families' => [
            'Abhaya Libre' => [
                'normal' => storage_path('fonts/AbhayaLibre-Regular.ttf'),
                'bold' => storage_path('fonts/AbhayaLibre-Bold.ttf'),
                'semibold' => storage_path('fonts/AbhayaLibre-SemiBold.ttf'),
                'bold_italic' => storage_path('fonts/AbhayaLibre-Bold.ttf'),
            ],
            'Noto Sans Tamil' => [
                'normal' => storage_path('fonts/NotoSansTamil-Regular.ttf'),
                'bold' => storage_path('fonts/NotoSansTamil-Bold.ttf'),
                'bold_italic' => storage_path('fonts/NotoSansTamil-Bold.ttf'),
            ],
        ],
