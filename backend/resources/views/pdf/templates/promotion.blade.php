...
<body>
    ...
    <div class="subject">මාතෘකාව: ග්‍රාම නිලධාරී (I ශ්‍රේණිය) තනතුරට උසස් කිරීම</div>

    <div class="body-content">
        <p>{{ $officerName }} {{ $officerSalutation }},</p>

        <p><span class="para-num">01.</span> ඔබව ග්‍රාම නිලධාරී (I ශ්‍රේණිය) තනතුරට {{ $letterDate }} දින සිට බලපැවැත්වෙන පරිදි උසස් කර ඇති බව දන්වා සිටිමි.</p>
