...
<body>
    ...
    <div class="subject">මාතෘකාව: සේවයෙන් විශ්‍රාම ගැන්වීම</div>

    <div class="body-content">
        <p>{{ $officerName }} {{ $officerSalutation }},</p>

        <p><span class="para-num">01.</span> ඔබ වසර 60 සම්පූර්ණ කිරීම හේතුවෙන් {{ $letterDate }} දින සිට බලපැවැත්වෙන පරිදි ග්‍රාම නිලධාරී සේවයෙන් විශ්‍රාම ගැන්වීම අනුමත කර ඇත.</p>

        <p><span class="para-num">02.</span> ඒ අනුව, ඔබේ රාජකාරි {{ $dsDivisionSi }} ප්‍රාදේශීය ලේකම්වරයා වෙත භාරදීමට කටයුතු කරනු මැනවි.</p>

        <p><span class="para-num">03.</span> ඔබගේ විශ්‍රාම වැටුප්, දීමනා සහ අනෙකුත් ප්‍රතිලාභ සඳහා අවශ්‍ය කටයුතු විශ්‍රාම වැටුප් අධ්‍යක්ෂ ජනරාල්වරයා හරහා සිදු කෙරේ.</p>

        <p><span class="para-num">04.</span> ඒ සඳහා අවශ්‍ය ලිපි ලේඛන {{ $dsDivisionSi }} ප්‍රාදේශීය ලේකම් කාර්යාලය හරහා ඉදිරිපත් කරන ලෙස ඉල්ලා සිටිමි.</p>
    </div>
