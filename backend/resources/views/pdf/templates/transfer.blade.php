...
<body>
    ...
    <div class="subject">මාතෘකාව: ස්ථාන මාරු කිරීම</div>

    <div class="body-content">
        <p>{{ $officerName }} {{ $officerSalutation }},</p>

        <p><span class="para-num">01.</span> ඔබව {{ $fromDsDivisionSi }} ප්‍රාදේශීය ලේකම් කොට්ඨාසයේ {{ $gnDivision }} ග්‍රාම නිලධාරී වසමේ සිට {{ $toDsDivisionSi }} ප්‍රාදේශීය ලේකම් කොට්ඨාසයට {{ $letterDate }} දින සිට බලපැවැත්වෙන පරිදි ස්ථාන මාරු කර ඇත.</p>

        <p><span class="para-num">02.</span> ඒ අනුව, ඔබ වර්තමාන රාජකාරි {{ $fromDsDivisionSi }} ප්‍රාදේශීය ලේකම්වරයා වෙත භාරදී, {{ $toDsDivisionSi }} ප්‍රාදේශීය ලේකම්වරයා වෙත වාර්තා කර රාජකාරි භාරගනු මැනවි.</p>

        <p><span class="para-num">03.</span> ඔබේ ස්ථාන මාරුවීමේ ගමන් වියදම් {{ $fromDsDivisionSi }} ප්‍රාදේශීය ලේකම් කාර්යාලය මගින් ගෙවීමට කටයුතු කර ඇත.</p>
    </div>
